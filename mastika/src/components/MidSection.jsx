...
const MidSection = () => {
  return (
    <div>
      <section className="relative w-11/12 max-w-[1080px] mx-auto -z-50">
        <div>
          <h2 className="text-[40px] leading-[48px] pb-[16px] text-[#404659] font-mulish font-bold">
            A br/oad Treatment <br /> Spectrum
          </h2>
          <p className="mb-[40px] text-[20px] leading-[30px] text-[#141b2c] font-mulish">
            We support you in coping with mental illnesses including <br />{" "}
      ...
      <section className=" relative w-11/12  max-w-[1080px]   -z-50 ">
        ...
        >
          ...
          <h2 className="text-[40px] leading-[48px] text-[#fff] font-mulish  font-bold">
            Digital Psychotherapy <br /> and Self-care for You
          </h2>
        </div>
      </section>
      ...
      <section className="relative w-11/12 max-w-[1080px] mx-auto -z-50">
        <h2 className="text-[40px] leading-[48px] pb-[16px] text-[#404659] font-mulish font-bold">
          Learn more about Mental <br /> Health
        </h2>
        <p className="text-[#141b2c] text-[20px] leading-[30px] font-mulish mb-16">
          Our clinical psychologists regularly write insightful <br /> articles
          about mental health for our MindDoc magazine.
        </p>
        ...
        <div className="flex relative justify-between  ">
          ...
          <div className="w-[50%]">
            <img
              src="./images/learnmoreaboutmentalhealthimg1.png"
              alt=""
              className="rounded-[20px] "
            />
            <p className="text-[18px] leading-[25px] mt-[20px] mb-[10px] text-[#141414] font-mulish font-extrabold">
              When Fear Becomes A Problem – Anxiety <br /> Disorder and
              Depression
            </p>
            <p className="text-[18px] leading-[27px] mb-[16px] font-mulish">
              Next to depression, anxiety disorders are among the <br /> most
              common mental illness in western countries.
            </p>
          </div>

          <div className="w-[50%]">
            <img
              src="./images/learnmoreaboutmentalhealthim2.png"
              alt=""
              className="rounded-[20px]"
            />
            <p className="text-[18px] leading-[25px] mt-[20px] mb-[10px] text-[#141414] font-mulish font-extrabold">
              Too Much Stress at Work? Be Aware of These <br /> Three Warning
              Signs!
            </p>
            <p className="text-[18px] leading-[27px] mb-[16px] font-mulish">
              A free weekend or just a single day of hard-earned <br />{" "}
              relaxation can be so important to us. But are we able to <br />{" "}
              relax after all the hard work?
            </p>
          </div>
        </div>
        <div className="cursor-pointer group">
          <button
            className=" py-3 my-4 px-6 
            rounded-[100px] font-bold text-sm cursor-pointer bg-[#ebe1dd] group-hover:bg-buttoncolor text-[#4d7f7f]  text-[16px] leading-[20px] transition-all duration-200 
            hover:text-lightBlue500 "
          >
            Show all{" "}
      ...
      <section className="relative w-11/12 max-w-[1080px]">
        ...
        <div className="flex justify-between w-full ml-[12%] mt-14">
          ...
          <div className="w-[25%] -z-10">
            ...
            <p className="mt-[34px] text-[18px] leading-[27px] mb-[16px] font-bold font-mulish">
              "Minddoc combines excellent <br /> psychotherapy with flexibility{" "}
              <br /> of time and space."
            </p>
            <p clacc="text-[14px] leading-[21px] font-mulish mt-[16px] text-[#000000]">
              MindDoc Patient
            </p>
          ...
          <div className="w-[25%] -z-10">
            ...
            <p className="mt-[34px] text-[18px] leading-[27px] mb-[16px] font-bold font-mulish">
              "“So helpful. It is digging into <br /> parts of br/ain and
              depression <br /> that I haven't been able to <br /> access.”"
            </p>
            <p clacc="text-[14px] leading-[21px] font-mulish mt-[16px] text-[#000000]">
              App User
            </p>
